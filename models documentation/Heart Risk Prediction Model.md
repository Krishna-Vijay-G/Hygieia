...
<h1 align="center">Heart Risk Predictive Model</h1>

<p align="center">
  <strong>AdaBoost Ensemble Classifier for Cardiovascular Risk Assessment</strong>
</p>
...
graph TD
    ...
    E["📊 STANDARD SCALING<br/>z = (x - μ) / σ<br/>Fit on train only"]:::transform --> F
    ...
    classDef transform fill:#E8F5E9,stroke:#388E3C,stroke-width:2px,color:#000
